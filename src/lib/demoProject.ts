...
export const demoProject: ImportRouteData = {
  ...
  albumCaptionsEnabled: true,
  photoStyle: "classic",
  photoFrameStyle: "rounded-card",
  photoAnimation: "fade",
  ...
  locations: [
    {
      ...
      chapterDate: "Day 1",
      photos: [
        { url: "/demo-photos/seattle-1.jpg", caption: "Pike Place Market vibes" },
        { url: "/demo-photos/seattle-2.jpg", caption: "Seattle skyline" },
      ],
      photoLayout: {
        mode: "auto",
        template: "hero",
